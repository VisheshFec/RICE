...
if uploaded_file is not None:
    ...
    ## Tabs
    if show_ml_lab_tab:
        tab1, tab2, tab3, tab4, tab5 = st.tabs([" 📋 Status ", " 📢 Customer Insigths ", " 🕵🏻‍♂️ Bad times Deep Dive ", " 🎯 Feature Prioritization ", " 🧪 ML Lab "])
    else:
        tab1, tab2, tab3, tab4 = st.tabs([" 📋 Status ", " 📢 Customer Insigths ", " 🕵🏻‍♂️ Bad times Deep Dive ", " 🎯 Feature Prioritization "])
    ...
    # Feature Prioritization (RICE) tab
    with tab4:
        tab_4.renderPrioritizationTab(reviews)
